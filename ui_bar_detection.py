...
"")
        ...
        self.verticalLayout_5 = QtWidgets.QVBoxLayout(self.tab_current)
        self.verticalLayout_5.setObjectName("verticalLayout_5")
        self.tableWidget_current = QtWidgets.QTableWidget(self.tab_current)
        font = QtGui.QFont()
        font.setFamily("等线")
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
        self.tableWidget_current.setFont(font)
        self.tableWidget_current.setObjectName("tableWidget_current")
        self.tableWidget_current.setColumnCount(5)
        self.tableWidget_current.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.tableWidget_current.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        font = QtGui.QFont()
        font.setFamily("等线")
        font.setBold(True)
        font.setWeight(75)
        item.setFont(font)
        self.tableWidget_current.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableWidget_current.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        font = QtGui.QFont()
        font.setFamily("等线")
        font.setBold(True)
        font.setWeight(75)
        item.setFont(font)
        self.tableWidget_current.setHorizontalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        font = QtGui.QFont()
        font.setFamily("等线")
        font.setBold(True)
        font.setWeight(75)
        item.setFont(font)
        self.tableWidget_current.setHorizontalHeaderItem(4, item)
        self.tableWidget_current.horizontalHeader().setDefaultSectionSize(120)
        self.verticalLayout_5.addWidget(self.tableWidget_current)
        self.tabWidget.addTab(self.tab_current, "")
        ...
        self.tableWidget_total = QtWidgets.QTableWidget(self.tab_total)
        font = QtGui.QFont()
        font.setFamily("等线")
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
        self.tableWidget_total.setFont(font)
        self.tableWidget_total.setObjectName("tableWidget_total")
        self.tableWidget_total.setColumnCount(2)
        self.tableWidget_total.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        font = QtGui.QFont()
        font.setFamily("等线")
        font.setBold(True)
        font.setWeight(75)
        item.setFont(font)
        self.tableWidget_total.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        font = QtGui.QFont()
        font.setFamily("等线")
        font.setBold(True)
        font.setWeight(75)
        item.setFont(font)
        self.tableWidget_total.setHorizontalHeaderItem(1, item)
        self.tableWidget_total.horizontalHeader().setDefaultSectionSize(200)
        self.verticalLayout_3.addWidget(self.tableWidget_total)
    ...
    def retranslateUi(self, MainWindow):
        ...
        item = self.tableWidget_current.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Correct rate"))
        item = self.tableWidget_current.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "Frame count"))
        item = self.tableWidget_current.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "Needle count"))
        item = self.tableWidget_current.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "Template label"))
        item = self.tableWidget_current.horizontalHeaderItem(4)
        item.setText(_translate("MainWindow", "Predict label"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_current), _translate("MainWindow", "Predict result"))
        item = self.tableWidget_total.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "File path"))
        item = self.tableWidget_total.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "Needle total counts"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_total), _translate("MainWindow", "Template file"))
