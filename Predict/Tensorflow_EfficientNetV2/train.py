...
def main():
    data_root = r"E:\NAR\Predict\data"  # get data root path

    if not os.path.exists("./save_weights"):
        os.makedirs("./save_weights")

    img_size = {"s": [32, 90],  # train_size, val_size
                "m": [384, 480],
                "l": [384, 480]}
    num_model = "s"
    ...
    train_ds, val_ds = generate_ds(data_root,
                                   train_im_height=img_size[num_model][1],
    ...
    model.build((1, img_size[num_model][1], img_size[num_model][0], 3))
    model.summary()
